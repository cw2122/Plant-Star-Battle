...
bool is_debug = false;				// 是否开启调试模式, 按键'Q'来控制
bool is_start_invulnerable = false;		// 是否开启无敌帧模式, 按键'P'来控制
...
IMAGE img_gloomshroom_selector_background_left;		//选角界面朝向左的开朗菇背景图片
IMAGE img_gloomshroom_selector_background_right;	//选角界面朝向右的开朗菇背景图片
...
Atlas atlas_gloomshroom_idle_left;			//开朗菇朝向左的默认动画图集
Atlas atlas_gloomshroom_idle_right;			//开朗菇朝向右的默认动画图集
Atlas atlas_gloomshroom_run_left;			//开朗菇朝向左的奔跑动画图集
Atlas atlas_gloomshroom_run_right;			//开朗菇朝向右的奔跑动画图集
Atlas atlas_gloomshroom_attack_ex_left;		//开朗菇朝向左的特殊攻击动画图集
Atlas atlas_gloomshroom_attack_ex_right;	//开朗菇朝向右的特殊攻击动画图集
Atlas atlas_gloomshroom_die_left;			//开朗菇朝向左的死亡动画图集
Atlas atlas_gloomshroom_die_right;			//开朗菇朝向右的死亡动画图集
...
Atlas atlas_bubbles;				//普通攻击泡沫动画图集
Atlas atlas_bubbles_ex;				//特殊攻击泡沫动画图集
...
IMAGE img_avatar_gloomshroom;		//开朗菇头像图片
...
void load_game_resources() {
	...
	mciSendString(_T("open resources/nut_dash.wav alias nut_dash"), NULL, 0, NULL);
